...
basedir = 'C:\Users\Kirpal\Documents'
print "basedire", basedir
userdir = os.path.join(basedir, 'test\Atoll_Users')
print "userdir", userdir
pathloss1 = os.path.join(basedir, 'test\AtollPathlossData1')

pathloss2 = os.path.join(basedir, 'test\AtollPathlossData2')

print "pathloss1 ", pathloss1
...
if __name__ == '__main__':
    ...
    for d in dirs:
        ...
        logFile = os.path.join(basedir, 'test\AtollData\Dev\Log\{}'.format(logName))
